<form method="POST" action="{{ route('logout') }}">
    ...
    <button
        ...
        title="{{ __('Logout') }}">
         <span class="w-8 h-8 flex items-center justify-center"><img src="{{ asset('icons/logout_admin.png') }}" alt="{{ __('Logout') }}" class="w-8 h-8 object-contain translate-y-0.5"></span>
        <span>{{ __('Logout') }}</span>
    </button>
</form>
