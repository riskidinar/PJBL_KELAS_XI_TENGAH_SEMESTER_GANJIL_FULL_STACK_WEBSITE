...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-5 flex items-start justify-between">
        ...
        <span class="w-10 h-10 flex items-center justify-center bg-emerald-50 rounded-xl text-lg">🧑‍💼</span>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-5 flex items-start justify-between">
        ...
        <span class="w-10 h-10 flex items-center justify-center bg-orange-50 rounded-xl text-lg">💳</span>
    </div>
