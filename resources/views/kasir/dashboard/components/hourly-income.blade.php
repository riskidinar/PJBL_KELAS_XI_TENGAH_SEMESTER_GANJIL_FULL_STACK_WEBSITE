...
<div class="bg-white rounded-2xl border border-slate-200 p-5">
    ...
    <div class="flex items-start justify-between mb-1">
        <div>
            ...
            <p class="text-sm text-slate-400 mt-1 max-w-sm">
                {{ __('Intraday trend from 08:00 to 20:00 across all active POS terminals') }}
            </p>
        </div>
    ...
    <div class="grid grid-cols-2 gap-4 mt-5">
        <div class="flex items-center gap-3 bg-slate-50 rounded-xl p-3">
            <span class="w-9 h-9 flex items-center justify-center bg-white rounded-lg text-lg"><img src="{{ asset('icons/cash_admin.png') }}" class="w-4 h-4 object-contain"></span>
            <div class="flex-1">
        ...
        <div class="flex items-center gap-3 bg-slate-50 rounded-xl p-3">
            <span class="w-9 h-9 flex items-center justify-center bg-white rounded-lg text-lg"><img src="{{ asset('icons/qris_admin.png') }}" class="w-4 h-4 object-contain"></span>
            <div class="flex-1">
