...
<div class="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-7 gap-4 mb-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-4">
        ...
        <p class="text-xs text-emerald-600 mt-1">{{ $stats['fresh_categories'] }} fresh categories</p>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-4">
        ...
        <p class="text-xs text-slate-400 mt-1">{{ $stats['stock_plentiful'] }} plentiful in stock</p>
    </div>
    ...
    <div class="bg-orange-50 rounded-2xl border border-orange-100 p-4">
        <div class="flex items-center justify-between mb-3">
            ...
            <span class="w-7 h-7 flex items-center justify-center bg-orange-500 text-white rounded-lg">⚠️</span>
        </div>
    ...
    <div class="bg-red-50 rounded-2xl border border-red-100 p-4">
        <div class="flex items-center justify-between mb-3">
            ...
            <span class="w-7 h-7 flex items-center justify-center bg-red-500 text-white rounded-lg">⛔</span>
        </div>
